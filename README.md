...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/probed-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14472&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/probed-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `probed` can be installed with:

```
conda install probed
```

It is possible to list all of the versions of `probed` available on your platform with:
